$( document ).ready(function() {
    ...
    $('.upvote-post').on('click', function (e) {
      ...
      .done(function( response ) {
        ...
        $(`center#${postId} > .card.text-white.bg-info.mb-3.text-center > .card-body > p.upvotes-count`)[0].innerText = "Upvotes: " + response.upvotes
      });
    ...
    $('.downvote-post').on('click', function (e) {
      ...
      .done(function( response ) {
        console.log(response)
        $(`center#${postId} > .card.text-white.bg-info.mb-3.text-center > .card-body > p.downvotes-count`)[0].innerText = "Downvotes: " + response.downvotes
      });
